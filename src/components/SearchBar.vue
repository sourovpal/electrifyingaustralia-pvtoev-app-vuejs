...
<template>
  <section
    class="search-bar px-3 d-flex justify-content-between align-items-center"
  >
    <div
      ref="searchBoxRef"
      class="search-box"
    ...
    >
      ...
      >
        <ul class="project-list p-0 m-0">
          ...
          >
            <router-link
              :to="`/platform/${project.pipeline ? 'deals' : 'leads'}/${
                project.lead_id
              }`"
              class="item-link"
            >
              <div
                class="search-result d-flex justify-content-between align-items-center"
              >
                <div
                ...
                >
                  <div class="w-100">
                    <div
                      class="search-item text-head d-flex justify-content-between align-items-center"
                    >
                      <span>
                        {{
                          formatLeadAddress(
                      ...
                      >
                        <span
                          class="text-overflow-ellipsis btn btn-sm py-0 px-2 shadow-0"
                          :class="{
