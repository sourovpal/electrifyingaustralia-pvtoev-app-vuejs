  ...
  <nav class="navbar navbar-vertical d-none d-md-flex shadow-none">
    <div class="navbar-top">
      <div class="nav-item">
        <router-link
          to="/app"
          v-tippy="{ content: 'Home', placement: 'right' }"
          class="navbar-brand nav-link"
          data-mdb-toggle="tooltip"
          data-mdb-placement="right"
        >
          <font-awesome-icon class="text-head" icon="fas fa-solar-panel" />
        </router-link>
      </div>

      <div class="nav-item">
        <router-link
          v-tippy="{ content: 'Platform', placement: 'right' }"
          :to="getLeadPrevUrl ?? data.platform_url"
          class="navbar-brand nav-link"
        >
          <font-awesome-icon class="text-head" icon="fas fa-users" />
        </router-link>
      </div>
      ...
      <div class="nav-item">
        <router-link
          to="/map"
          v-tippy="{ content: 'Map', placement: 'right' }"
          class="navbar-brand nav-link"
        >
          <font-awesome-icon class="text-head" icon="fas fa-map-location-dot" />
        </router-link>
      </div>

      <div class="nav-item">
        <router-link
          v-tippy="{ content: 'Library', placement: 'right' }"
          to="/library"
          class="navbar-brand nav-link"
        >
          <font-awesome-icon class="text-head" icon="fas fa-folder-open" />
        </router-link>
      </div>

      <div class="nav-item">
        <router-link
          v-tippy="{ content: 'Payments', placement: 'right' }"
          to="/payments"
          class="navbar-brand nav-link"
        >
          <font-awesome-icon class="text-head" icon="fas fa-cart-shopping" />
        </router-link>
      </div>
    </div>
