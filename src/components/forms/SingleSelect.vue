<template>
    <div class="custom-select dropdown" @click="toggleDropdown">
      ...
      <input class="form-control cursor-pointer" data-mdb-toggle="dropdown" :value="selectedOptionLabel" readonly>
      ...
      <div class="dropdown-menu fade custom-form-select overflow-auto slim-scrollbar-">
          <div
            ...
            :class="{ 'selected': isSelected(option?.value??option, option?.label??option) }"
