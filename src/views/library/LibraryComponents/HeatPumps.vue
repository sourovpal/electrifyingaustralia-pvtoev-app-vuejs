<template>
    <div class="overflow-x-hidden">
 	    <div class="row align-items-baseline border-bottom py-3 px-4">
		    <p class="text-end fs-14px col-md-4 mb-0 text-secondary">Add a heat pump</p>
		    <div class="col-md-8">
                <input class="form-control" placeholder="Search for heat pump models" />
		    </div>
	    </div>
	    <div class="graphic d-flex flex-column align-items-center">
	        ...
	        <p class="text-muted mb-0">Search to add a heat Pump</p>
	    </div>
    </div>
</template>
