    ...
    <div class="dropdown form-control px-0"
        ...
        <ul class="option-list d-flex flex-wrap">
          <li class="option-item"
            ...
            <span class="remove-btn"
              @click="removeItem(option)">&times;</span>
          </li>
      ...
      <Transition>
        <div v-if="isOpen"
          ...
          <ul class="item-list">
            <li v-if="!multiple && !input"
              class="search-item px-2 py-0">
              <input type="text"
                placeholder="Search..."
                v-model="searchOption" />
            </li>
      ...
      <span class="selected-option"
        ...
        @click="toggleOptionList">{{ selectedOptions?.join(",") }}</span>
      ...
      <span v-if="!multiple && !input && !selectedOptions.length"
        class="selected-option">{{ placeholder }}</span>
    </div>
  </div>
</template>
