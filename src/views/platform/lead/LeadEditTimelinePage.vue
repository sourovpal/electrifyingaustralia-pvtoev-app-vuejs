  ...
  <section class="content lead-edit">
    ...
    <action-bar :class="{ 'border-0': isPipelineLead }">
      ...
      <right-action-bar>
        ...
        <router-link
          v-if="!isPipelineLead && !isFirstLoading"
        ...
        <button
          @click="toggleRightDetailsSidebarHandler()"
        ...
        >
          ...
          >
            <span
              ...
              >{{ currentLead?.status?.name ?? "Lead Status" }}</span
            >
          ...
          >
            <span
              ...
              :class="`${
                status.name == currentLead?.status?.name ? 'selected' : ''
              }`"
        ...
        >
          ...
          >
            <div class="icon">
              <img v-if="owner?.id" :src="owner?.profile_avatar" alt="" />
              <img v-else :src="AvatarIcon" alt="" />
            </div>
          </button>
        ...
        <button
          class="toolbar-btn btn btn-light btn-sm btn-floating me-3 d-none d-lg-inline"
        >
          <svg
            class="svg-5"
            xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="me-3 position-relative">
          ...
          >
            ...
            >
            <span
              @click="$refs['leadReCategoriseModalRef'].showModalHandler()"
    ...
    <Transition>
      ...
      >
        <left-action-bar class="w-100">
          <div
            class="pipeline-progress-bar w-100 d-flex justify-content-between align-items"
          >
            <div
              class="btn-group shadow-0 white-space-nowrap w-100 overflow-auto"
            >
              <button
                ...
                :class="{
                  complete:
                    stage?.lead_stage &&
                    currentLead?.pipeline_stage_id != stage?.id &&
                    currentLead?.is_lost != 0,
                  active:
                    currentLead?.pipeline_stage_id == stage?.id &&
                    currentLead?.is_lost != 0,
        ...
        <div class="d-flex py-1 current-pipeline-stage">
          <span class="mb-0 fs-16px text-soft fw-bold me-1"
            >{{ currentLead?.pipeline?.title }}:</span
          >
          <span class="mb-0 fs-16px text-soft">{{
            currentLead?.pipeline_stage?.name
          }}</span>
        </div>
      </action-bar>
    </Transition>
