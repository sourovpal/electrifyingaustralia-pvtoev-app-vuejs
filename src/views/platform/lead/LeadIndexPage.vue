<script>
  ...
  export default {
    ...
    setup(props) {
      ...
      return { leadStore, appStore, AvatarIcon, moment };
    },
    ...
    <action-bar>
        ...
        <div v-if="selectedRows.length"
          ...
          <div class="dropdown-menu dropdown-menu-end shadow-md custom-dropdown-menu"
            ...
            <span style="width: 170px"
              ...
              <svg-custom-icon v-if="status?.is_lost"
                icon="lost-icon" />
            </span>
          </div>
        </div>
      ...
      <right-action-bar>
        ...
        <div class="btn-group me-3"
          v-if="Object.keys(customFilterFormData).length">
          <button class="btn btn-success btn-sm">
            {{ Object.keys(customFilterFormData).length }} active filter
          </button>
        ...
        <div v-if="!Object.keys(customFilterFormData).length"
        ...
        <button :disabled="!pagination?.prev_page || isLoading"
          @click="
            pagination?.prev_page && paginationHandler({ page: pagination?.prev_page })
          "
        ...
        <button :disabled="!pagination?.next_page || isLoading"
          ...
          @click="
            pagination?.next_page && paginationHandler({ page: pagination?.next_page })
          "
          class="toolbar-btn btn btn-light btn-floating me-3">
          <svg class="svg-5"
            xmlns="http://www.w3.org/2000/svg"
