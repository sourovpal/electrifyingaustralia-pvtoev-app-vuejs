...
import LeadIndexMixins from "./mixins/LeadIndexMixins";
  ...
  <section class="content lead-list">
    ...
    <action-bar>
      <left-action-bar>
        ...
        >
          <span class="fs-14px d-none d-xl-inline"
      ...
      <right-action-bar>
        ...
        <div class="me-3 d-none d-xl-block">
          <div class="dropdown import-dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
              <li
                @click="$refs['UploadSpreadsheetModalRef'].showModalHandler()"
              >
              ...
              <li>
                <a class="dropdown-item" href="#">Connect to lead providers</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div
          class="fw-bold d-flex justify-content-center align-items-center me-2 text-overflow-ellipsis fs-16px d-none d-xl-block"
        ...
        <button
          ...
          @click="
            pagination?.prev_page &&
              updateUrlQuery({ page: pagination?.prev_page })
          "
        ...
        <button
          ...
          @click="
            pagination?.next_page &&
              updateUrlQuery({ page: pagination?.next_page })
          "
          class="toolbar-btn btn btn-light btn-floating me-3"
        >
          <svg
        ...
        <div class="me-3 d-lg-inline d-xl-none">
          <button
            class="toolbar-btn btn btn-light btn-sm btn-floating"
            data-mdb-toggle="dropdown"
          >
            <svg
              class="svg-5"
          ...
          >
            <span
              @click="$refs['AddNewLeadModalRef'].showModalHandler()"
              class="dropdown-item cursor-pointer text-head"
              >Add New</span
            >
    ...
    <Datatable>
      ...
      <datatable-header class="" v-if="isFirstLoading || fetchLeads.length">
        ...
        <div
          v-show="!disabledHeaderColumns.includes('lead')"
          class="tbl-th"
        ...
        <div
          v-show="!disabledHeaderColumns.includes('phone_number')"
        ...
        <div
          v-show="!disabledHeaderColumns.includes('email_address')"
          class="tbl-th"
        ...
        <div
          v-show="!disabledHeaderColumns.includes('address_line_one')"
          class="tbl-th"
          style="width: 10rem; flex-grow: 1"
        >
          Address One
        ...
        <div
          v-show="!disabledHeaderColumns.includes('address_line_two')"
          class="tbl-th"
          style="width: 10rem; flex-grow: 1"
        >
          Address Two
        ...
        <div
          v-show="!disabledHeaderColumns.includes('city')"
          class="tbl-th"
          style="width: 10rem; flex-grow: 1"
        >
          City
        ...
        <div
          v-show="!disabledHeaderColumns.includes('state')"
          class="tbl-th"
          style="width: 10rem; flex-grow: 1"
        >
          State
        ...
        <div
          v-show="!disabledHeaderColumns.includes('country')"
          class="tbl-th"
          style="width: 10rem; flex-grow: 1"
        >
          Country
        ...
        <div
          v-show="!disabledHeaderColumns.includes('owner')"
          class="tbl-th"
          style="width: 10rem; flex-grow: 1"
        >
          Owner
      ...
      <datatable-body>
        ...
        >
          ...
          <div
            ...
            class="tbl-td"
          >
            <a class="text-overflow-ellipsis" href="">{{
