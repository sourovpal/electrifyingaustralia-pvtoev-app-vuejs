...
<template>
        ...
        <action-bar>
            ...
            <left-action-bar>
                <div class=" d-flex justify-content-center align-item-start"
                    ...
                    <label class="custom-form-checkbox btn btn-floating btn-light"
                        ...
                        <svg v-else-if="isSelectedAllRows && !isSelectedAllRowsReset"
                            class="checked"
                            xmlns="http://www.w3.org/2000/svg"
                            fill="currentColor"
                            width="24"
                ...
                <div v-if="selectedRows.length"
                    ...
                    <button style="width:130px;"
                        ...
                        aria-expanded="false">
                        <span class="fw-bold text-fs tbl-dropdown-title text-overflow-ellipsis text-head">Lead
                            Status</span>
            ...
            <right-action-bar>
                ...
                <div class="btn-group  me-3"
                    ...
                    <button class="btn btn-success btn-sm">{{ Object.keys(filterQueryData).length }} active
                        filter</button>
                ...
                <div class="me-3 d-none d-xl-block">
                    <div class="dropdown import-dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li @click="$refs['UploadSpreadsheetModalRef'].showModalHandler()"><a
                                    class="dropdown-item cursor-pointer">Upload spreadsheet...</a></li>
                            <li><a class="dropdown-item"
                                    href="#">Connect to lead providers</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div v-if="!Object.keys(filterQueryData).length"
        ...
        <Datatable>
            ...
            <datatable-header class=""
                ...
                <div v-show="!disabledHeaderColumns.includes('lead')"
                    class="tbl-th"
                    style="width:20rem;flex-grow: 1;">Lead</div>
                ...
                <div v-show="!disabledHeaderColumns.includes('source')"
                    ...
                    Source <column-sorted field="source"
                        :column="column"
                        :order="order" />
                </div>
                ...
                <div v-show="!disabledHeaderColumns.includes('status')"
                    ...
                    Status <column-sorted field="status"
                        :column="column"
                        :order="order" />
                </div>
                ...
                <div v-show="!disabledHeaderColumns.includes('phone_number')"
                    ...
                    style="width:12rem;flex-grow: 1;">Phone Number</div>
                ...
                <div v-show="!disabledHeaderColumns.includes('country')"
                    class="tbl-th"
                    style="width:10rem;flex-grow: 1;">Country</div>
                ...
                <div v-show="!disabledHeaderColumns.includes('first_create')"
                    ...
                    class="tbl-th cursor-pointer"
                    style="width:10rem;flex-grow: 1;">
                    Created At <column-sorted field="created_at"
                        :column="column"
                        :order="order" />
                </div>
                ...
                <div v-show="!disabledHeaderColumns.includes('owner')"
                    class="tbl-th"
                    style="width:10rem;flex-grow: 1;">Owner</div>
            ...
            <datatable-body>
                ...
                <div :class="selectedRows.includes(lead.id)?'active':''"
                    ...
                    <div style="width:4rem;margin-left: -7px;flex-grow: 1;"
                        ...
                        <label @click="singleRowSelectedHandler(lead.id)"
                            class="custom-form-checkbox btn btn-floating btn-light">
                            <svg v-if="!selectedRows.includes(lead.id)"
                                class="unchecked"
                                xmlns="http://www.w3.org/2000/svg"
                                fill="currentColor"
                                height="24"
                        ...
                        <div class="dropdown w-100">
                            <button
                                ...
                                <span class="fw-bold text-fs tbl-dropdown-title text-overflow-ellipsis text-head">{{
                                    lead.status?.name??'Lead Status' }}</span>
                                <div class="dropdown--icon">
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        width="24"
                                        height="24"
                    ...
                    <div v-show="!disabledHeaderColumns.includes('city')"
                        style="width:10rem;flex-grow: 1;"
                        class="tbl-td"> {{ lead.city }}</div>

                    <div v-show="!disabledHeaderColumns.includes('state')"
                        style="width:10rem;flex-grow: 1;"
                        class="tbl-td"> {{ lead.state }}</div>

                    <div v-show="!disabledHeaderColumns.includes('post_code')"
                        style="width:10rem;flex-grow: 1;"
                        class="tbl-td"> {{ lead.post_code }}</div>

                    <div v-show="!disabledHeaderColumns.includes('country')"
                        style="width:10rem;flex-grow: 1;"
                        class="tbl-td"> {{ lead.country }}</div>
                    ...
                    <div v-show="!disabledHeaderColumns.includes('last_update')"
                        style="width:10rem;flex-grow: 1;"
                        class="tbl-td">{{ lead.updated_at }}</div>

                    <div v-show="!disabledHeaderColumns.includes('first_create')"
                        style="width:10rem;flex-grow: 1;"
                        class="tbl-td">{{ lead.created_at }}</div>
    ...
    <!-- ============================ -->
    <add-new-lead-modal :fetchAllLeadsHandler="fetchAllLeadsHandler"
        ref="AddNewLeadModalRef"
        :lead-sources="leadSources"
        :lead-status="leadStatus"
        :owners="owners" />

    <delete-multiple-lead-warning-modal ref="DeleteMultipleLeadModalRef"
        :selectedRows="selectedRows"
        :fetchAllLeadsHandler="fetchAllLeadsHandler" />

    <upload-spreadsheet-modal ref="UploadSpreadsheetModalRef" />
