                ...
                <div class="row m-0">
                        ...
                        <div class="modal-body p-0 pt-3">
                            ...
                            <div class="mb-3">
                                <label class="form-label-title"
                                    for="">Contact person <span class="text-soft fs-12px ms-1">(Required)</span>
                                </label>
                            ...
                            <div class="mb-3">
                                <label class="form-label-title"
                                    for="">Address <span class="text-soft fs-12px ms-1">(Optional)</span> </label>
                            ...
                            <div class="mb-3">
                                <label class="form-label-title"
                                    for="">Phone or email <span class="text-soft fs-12px ms-1">(Optional)</span>
                                </label>
                            ...
                            <div class="mb-3">
                                <label class="form-label-title"
                                    for="">Lead source <span class="text-soft fs-12px ms-1">(Optional)</span> </label>
                                <input @click="delete errors?.lead_source"
                                    class="form-control"
                    ...
                    <div class="col-lg-4 lead-details-right">
                        ...
                        <div class="modal-body p-0 pt-3">
                            <div class="mb-3">
                                <label class="form-label-title"
                                    for="">Lead title <span class="text-soft fs-12px ms-1">(Optional)</span> </label>
                            ...
                            <div class="mb-3 position-relative">
                                <label class="form-label-title"
                                    for="">Lead status <span class="text-soft fs-12px ms-1">(Optional)</span> </label>
                            ...
                            <div class="mb-3">
                                <label class="form-label-title"
                                    for="">Tags <span class="text-soft fs-12px ms-1">(Optional)</span> </label>
                ...
                <div class="row m-0">
                    <div class="col-lg-8  pb-2">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <button :disabled="isSubmitCreateLeadForm"
                                    @click="createNewLeadHandler()"
                                    type="submit"
