...
<template>
    <div class="col-right"
            ...
            <div class="personal-info px-3 py-3 border-bottom">
                <div class="d-flex justify-content-between align-items-center mb-1 position-relative">
                    ...
                    <div class="dropdown-menu dropdown-menu-end shadow-md custom-dropdown-menu three-dot">
                        <span @click="$refs['contactEditModalRef'].showModalHandler(contact)"
                            class="dropdown-item cursor-pointer text-head py-1">Edit Contact</span>
                        <span :data-mdb-toggle="`${!contact?.is_primary?'modal':''}`"
                ...
                <div>
                    <table class="tbl-contact-info w-100">
                        ...
                        <tr v-if="contact?.email">
                            ...
                            <td class="fs-16px">
                                <a class="d-block user-email text-head"
                                    :href="`mailto:${contact?.email}`">{{ contact?.email }}</a>
                            </td>
                            <td class="hover"
                                width="20%">
                                <div class="d-flex justify-content-end align-items-center">
                                    <button @click="copyToClipboard(contact?.email)"
                        ...
                        <!-- Another Emails -->
                        <tr v-for="(item, index) in contact?.another_emails??[]"
                            :key="index">
                            <td class="fs-16px"
                                width="10%">
                                <svg class="svg-5"
                            ...
                            <td class="fs-16px"><a class="d-block user-email text-head"
                                    :href="`mailto:${item?.email}`">{{ item?.email }}</a></td>
                            <td class="hover"
                                width="20%">
                                <div class="d-flex justify-content-end align-items-center">
                                    <button @click="copyToClipboard(item?.email)"
                                        class="btn btn-sm btn-light btn-floating bg-transparent d-flex justify-content-center align-items-center">
                                        <svg class="svg-5"
                                            xmlns="http://www.w3.org/2000/svg"
                                            width="18"
                        ...
                        <tr v-if="contact?.phone_number">
                            ...
                            <td class="fs-16px">
                                <a class="d-block text-head user-phone"
                            ...
                            <td class="hover"
                                width="20%">
                                <div class="d-flex justify-content-end align-items-center">
                                    <button @click="copyToClipboard(contact?.phone_number)"
                                        class="btn btn-sm btn-light btn-floating bg-transparent d-flex justify-content-center align-items-center">
                                        <svg class="svg-5"
                                            xmlns="http://www.w3.org/2000/svg"
                                            width="18"
                        ...
                        <tr v-for="(item, index) in contact?.another_phones??[]"
                            :key="index">
                            <td class="fs-16px"
                                width="10%">
                                <svg class="svg-5"
                            ...
                            <td class="fs-16px"><a class="d-block text-head user-phone"
                                    :href="`tel:${item?.phone_number}`">{{ item?.phone_number }}</a></td>
                            <td class="hover"
                                width="20%">
                                <div class="d-flex justify-content-end align-items-center">
                                    <button @click="copyToClipboard(item?.phone_number)"
                                        class="btn btn-sm btn-light btn-floating bg-transparent d-flex justify-content-center align-items-center">
                                        <svg class="svg-5"
                                            xmlns="http://www.w3.org/2000/svg"
                                            width="18"
        ...
        <!-- Modal Area -->
        <ContactEditModal :findLeadByIdHandler="findLeadByIdHandler"
            ...
            <div class="modal-dialog modal-dialog-centered modal-sm mx-auto">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p class="fs-12px text-center text-danger">This action cannot be undone! To confirm your intent,
                            please click delete button.</p>
                        <div class="d-flex justify-content-between align-items-center">
                            <button class="btn btn-primary btn-sm"
                                data-mdb-dismiss="modal">Close</button>
                            <button class="btn btn-danger btn-sm"
                                data-mdb-dismiss="modal"
                                @click="deleteLeadContactHandler(contact)">Delete</button>
                        </div>
                    </div>
                </div>
            </div>
