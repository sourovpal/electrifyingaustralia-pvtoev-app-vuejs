    ...
    async selectSubscribersHandler(item) {
      ...
      try {
        const payload = {
          ...
          user_ids: [...this.selectedSubscribers, this.owner?.id],
        };
      ...
      <div>
        <div class="dropdown-body">
          ...
          >
            ...
            >
              <label
                class="custom-form-checkbox btn btn-floating btn-light me-2 disabled"
              >
                <svg
                  v-if="!selectedSubscribers.includes(item?.id)"
                  class="unchecked"
