    ...
    <div class="row pb-2">
      <div class="col-6 pe-0">
        ...
        <div class="properties-list slim-scrollbar">
          ...
          >
            <custom-checkbox
              :checked="!disabledHeaderColumns.includes(header.unique_id)"
            />
      ...
      <div class="col-6 ps-0">
        ...
        <div class="properties-list slim-scrollbar">
          ...
          >
            <span
              class="custom-form-checkbox btn btn-floating btn-light btn-sm"
            >
              <svg
                v-if="disabledHeaderColumns.includes(header.unique_id)"
                class="unchecked"
