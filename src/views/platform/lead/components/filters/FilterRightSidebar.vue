...
<template>
    <div id="right-filter-bar">
        <div class="header d-flex justify-content-between align-items-center">
            ...
            <div class="close"
                @click="toggleFilterSidebarHandler()">
                <svg class="svg-5"
                    xmlns="http://www.w3.org/2000/svg"
                    height="24px"
                    viewBox="0 0 24 24"
            ...
            <div class="filter-options">
                ...
                <div class="filter-option">
                    <div class="option-header d-flex justify-content-between align-items-center"
                        :class="{active:dropdownToggleItems['owners']}"
                        @click="toggleDropdownHandler('owners')">
                        <div class="d-flex justify-content-start align-items-center">
                            <div class="icon">
                                <svg class="svg-5"
                                    xmlns="http://www.w3.org/2000/svg"
                    ...
                    <slide-up-down :active="dropdownToggleItems['owners']"
                        :duration="300">

                        <div class="option-body">
                            <label @click="ownerFilterHandler(0)"
                            ...
                            <label v-for="(owner, index) in owners"
                                ...
                                class="d-flex justify-content-start align-items-center py-1 check-label-propertis">
                                <span class="custom-form-checkbox btn btn-floating btn-light btn-sm">
                                    <svg v-if="!ownerIds.includes(owner.id)"
                                        class="unchecked"
                                        xmlns="http://www.w3.org/2000/svg"
                                        fill="currentColor"
                                        height="24"
                                    ...
                                    <svg v-else="ownerIds.includes(owner.id)"
                                        class="checked"
                                        xmlns="http://www.w3.org/2000/svg"
                                        fill="currentColor"
                                        width="24"
                ...
                <div class="filter-option">
                    <div class="option-header d-flex justify-content-between align-items-center"
                        :class="{active:dropdownToggleItems['source']}"
                        @click="toggleDropdownHandler('source')">
                        <div class="d-flex justify-content-start align-items-center">
                            <div class="icon">
                                <svg class="svg-5"
                                    xmlns="http://www.w3.org/2000/svg"
                    ...
                    <slide-up-down :active="dropdownToggleItems['source']"
                        :duration="300">
                        <div class="option-body">
                            <div class="position-relative">
                                ...
                                <div class="dropdown-menu custom-form-select roles overflow-auto"
                                    ...
                                    <ul class="list-unstyled mb-0">
                                        <li v-for="(item, index) in filterLeadSources()"
                                            :key="index"
                ...
                <div class="filter-option">
                    <div class="option-header d-flex justify-content-between align-items-center"
                        :class="{active:dropdownToggleItems['tags']}"
                        @click="toggleDropdownHandler('tags')">
                        <div class="d-flex justify-content-start align-items-center">
                            <div class="icon">
                                <svg class="svg-5"
                                    xmlns="http://www.w3.org/2000/svg"
                    ...
                    <slide-up-down :active="dropdownToggleItems['tags']"
                        :duration="300">
                        <div class="option-body">
                            <input ref="tags"
                ...
                <div class="filter-option">
                    <div class="option-header d-flex justify-content-between align-items-center"
                        :class="{active:dropdownToggleItems['created_from_to']}"
                        @click="toggleDropdownHandler('created_from_to')">
                        <div class="d-flex justify-content-start align-items-center">
                            <div class="icon">
                                <svg class="svg-5"
                                    xmlns="http://www.w3.org/2000/svg"
                    ...
                    <slide-up-down :active="dropdownToggleItems['created_from_to']"
                        :duration="300">
                        <div class="option-body">
                            <div class="mb-3">
                                <label class="fs-14px text-soft"
                                    for="">From</label>
                                <input @input="searchHandler()"
                                    v-model="formData['created_from']"
                                    class="form-control form-control-sm fw-bold text-head"
                                    type="date"
                                    name=""
                                    id="">
                ...
                <div class="filter-option">
                    <div class="option-header d-flex justify-content-between align-items-center"
                        :class="{active:dropdownToggleItems['updated_from_to']}"
                        @click="toggleDropdownHandler('updated_from_to')">
                        <div class="d-flex justify-content-start align-items-center">
                            <div class="icon">
                                <svg class="svg-5"
                                    xmlns="http://www.w3.org/2000/svg"
                    ...
                    <slide-up-down :active="dropdownToggleItems['updated_from_to']"
                        :duration="300">
                        <div class="option-body">
                            <div class="mb-3">
                                <label class="fs-14px text-soft"
                ...
                <div class="filter-option"
                    ...
                    :key="index">
                    <div class="option-header d-flex justify-content-between align-items-center"
                        :class="{active:dropdownToggleItems[field.unique_id]}"
                        @click="toggleDropdownHandler(field.unique_id)">
                        <div class="d-flex justify-content-start align-items-center">
                            <div class="icon"
                                v-html="propertiesIconList[field?.data_type_id]"></div>
                    ...
                    <slide-up-down :active="dropdownToggleItems[field.unique_id]"
                        :duration="300">
                        <div class="option-body">

                            <div class="protected propertie-warpper"
                                v-if="field?.data_type_id === 'free_text'  || field?.data_type_id === 'multiline_free_text'"
                                :data-value="formData[field.unique_id]">
                                <input @change="searchHandler()"
                                    class="form-control form-control-sm fw-bold text-head"
                                    type="text"
