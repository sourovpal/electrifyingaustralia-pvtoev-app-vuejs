        ...
        <div class="row mx-0">
          <div class="col-lg-4 bg-col-left">
            <div class="modal-header py-2 px-0">
              <div
                class="d-flex justify-content-center align-items-center py-0"
              >
                <svg
                  class="svg-5 me-2"
          ...
          <div class="col-lg-8">
            <div class="modal-header py-2 px-0">
              ...
              >
                ...
                <span v-if="contact" class="text-hard fw-bold fs-16px"
                  >Edit Contact</span
                >
                <span v-if="!contact" class="text-hard fw-bold fs-16px"
                  >Add Contact</span
            ...
            <div class="modal-body px-0">
                ...
                <div class="col-lg-8 mb-3 mb-lg-0">
                  <div class="">
                    ...
                    <input
                      ...
                      :class="{
                        'border-error': errors?.phone_number && !phone_number,
                      }"
                ...
                <div class="col-lg-8 mb-3 mb-lg-0">
                  <div class="">
                    ...
                    <input
                      ...
                      :class="{
                        'border-error':
                          errors?.phone_number && !item.phone_number,
                      }"
              ...
              <div class="row mb-1">
                ...
                <div class="col-lg-4">
                  <div
                    @click="addedAnatherPhoneHandler()"
              ...
              <div class="row mb-1">
                ...
                <div class="col-lg-4">
                  <div
                    @click="addedAnatherEmailHandler()"
                    class="fs-14px text-primary cursor-pointer py-1 select-none"
                  >
                    Add another email
                  </div>
              ...
              <div class="mb-3" v-if="searchContacts.length">
                ...
                <div class="">
                  <ul class="list-unstyled mb-0 search-contacts">
                    <li
                      @click="createLeadContactHandler(item)"
              ...
              >
                ...
                <button
                  :disabled="isSubmitCreateNewContact"
