...
export default {
    ...
    methods: {
        ...
        fetchStatusTrueLeadFile(){
            return this.files?.filter(item=>item?.status == false);
        },
                ...
                <div class="lead-files">
                    ...
                    <div class="">
                        ...
                        <div class="files-progress-list">
                            <div class="item mb-2" v-for="(file, index) in fetchStatusTrueLeadFile()" :key="index">
                                ...
                                <div class="progress">
                                    <div class="progress-bar" :class="`${file?.progress == 100?'bg-success':''}`" :style="`width:${file?.progress}%;border-radius: 5px;`"></div>
                                </div>
                            </div>
                        </div>
                        <ul class="list-unstyled mt-3 file-list">
                            ...
                            v-for="(item, index) in leadFiles" :key="index">
                                <div @click="$refs['imagePreviewModalRef'].showModalHandler(item)">
                                    <img class="me-2" width="25" :src="getFileIconHandler(item?.extension)" alt="">
