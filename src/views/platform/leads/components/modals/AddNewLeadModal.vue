      ...
      <div class="col-lg-8">
        ...
        <div class="modal-body p-0 pt-3">
          ...
          <div class="mb-3">
            ...
            <input
              @click="delete errors?.phone_or_email"
          ...
          <div class="mb-3">
            <label class="form-label-title" for=""
              >Existing leads / deals</label
            >
            <span class="fs-12px text-soft"
              >No matching leads or deals found.</span
            >
          </div>
          <br />
        </div>
      ...
      <div class="col-lg-4 lead-details-right">
        ...
        <div class="modal-body p-0 pt-3">
          ...
          <div class="mb-3 add-new-lead-owner-list-dropdown">
            ...
            >
            <div
              @mouseover="delete errors?.lead_owner"
              @click="fetchUsers"
    ...
    <div class="row m-0">
      <div class="col-lg-8 pb-2">
        <div class="d-flex justify-content-between align-items-center">
          <div>
            <button @click="hideModal" class="btn btn-danger">Cancel</button>
          </div>
          <div>
            <loading-button
