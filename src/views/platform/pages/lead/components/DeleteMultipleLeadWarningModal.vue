...
<div class="modal fade add-new-lead-modal" id="deleteMultipleLeads" ref="deleteMultipleLeads" aria-hidden="true" aria-labelledby="deleteMultipleLeads" tabindex="-1">
        ...
        <div class="modal-content" style="border: 1px solid #dc4c64;">
            <div class="modal-header py-2">
                <div class="d-flex justify-content-center align-items-center py-0">
                    <svg class="me-2 svg-5" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="M280-120q-33 0-56.5-23.5T200-200v-520h-40v-80h200v-40h240v40h200v80h-40v520q0 33-23.5 56.5T680-120H280Zm400-600H280v520h400v-520ZM360-280h80v-360h-80v360Zm160 0h80v-360h-80v360ZM280-720v520-520Z"/></svg>
            ...
            <div class="modal-body">
                <p class="text-center fs-14px">
                    ...
                    To confirm your intent, please type the number of leads <strong>({{ selectedRows.length }})</strong> in the box below:
                </p>
                <div>
                    <input @click="delete errors?.lead_number" class="form-control" type="number" v-model="totalDeleteLeads">
                    <span class="fs-14px text-danger py-1 w-100 d-block" v-if="errors?.lead_number?.length">{{ errors?.lead_number[0] }}</span>
                </div>
            </div>
            <div class="modal-footer d-flex justify-content-between align-items-center border-0">
                <div>
                    <button @click="hideModalHandler()" class="btn btn-danger btn-sm">Cancel</button>
                </div>
                <div>
                    <button 
                    :disabled="isSubmitDeleteLead" 
