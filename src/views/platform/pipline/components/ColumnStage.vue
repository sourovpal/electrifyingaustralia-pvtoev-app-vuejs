...
<template>
    <div class="piplien-state"
        ...
        <div class="stage-header ps-3 pe-2 pt-2">
            <div class="d-flex justify-content-between align-items-center mb-2">
                <h5 class="mb-0 fs-18px text-head fw-bold">
                    {{ pipelineStage.name }}
                    <span class="ms-2 text-primary">( {{ pipelineStage?.leads_count }} )</span>
                </h5>
                <div class="ms-auto">
                    <button class="btn btn-sm btn-light btn-floating d-flex justify-content-center align-items-center">
            ...
            <div class="d-flex justify-content-between align-items-center pe-2 fs-14px">
                <span>Total</span>
                <span>${{ pipelineStage?.total_estimated_value??0.00 }}</span>
        ...
        <CustomScrollbar thumbWidth="3.5"
            direction="vertical">
