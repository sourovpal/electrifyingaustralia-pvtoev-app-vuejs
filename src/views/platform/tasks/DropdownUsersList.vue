        ...
        methods: {
            ...
            filterusers(){
                return this.users?.filter((item) =>{
                    if(this.searchuser){
                        if((item.name + item.email).toLowerCase().search(this.searchuser.toLowerCase()) > -1){
                            return item;
                        }
                    }else{
                        return item;
            ...
            <div>
                <div class="dropdown-body">
                    ...
                    <div class="dropdown-input">
                        <input v-model="searchuser" type="text" placeholder="Filter user" class="project-user-filter form-control" />
                    </div>
                    ...
                    <div v-else class="dropdown-item noselect" @click="$emit('user-selected', null)">
                        <img :src="icons?.avatar" draggable="false" alt="No user's avatar" class="project-user__profile-photo" />
                    ...
                    <div class="project-user-team-members slim-scrollbar-">
                        ...
                        <div class="dropdown-item px-2" v-if="(users?.length == 1 && user) || !users?.length">
