...
onMounted(() => {
  nextTick(() => {
    selectContactHandler(props.contactEdit);
  });
});
</script>
      ...
      <div class="col-lg-4 bg-col-left">
        <div class="modal-header py-2 px-0">
          <div class="d-flex justify-content-center align-items-center py-0">
            ...
            <span v-if="showLead" class="text-hard fw-bold fs-16px"
              >Related Deals</span
            >
            <span v-else class="text-hard fw-bold fs-16px">Contacts</span>
          </div>
          <div>
            <button
        ...
        <div class="modal-body px-0">
          <div v-if="showLead" class="lead-details p-2 bg-white">
            <router-link
              @click="hideModalHandler"
              :to="`/platform/leads/${editLead.lead_id}`"
            >
              <ul class="m-0 p-0 list-unstyled">
                <li v-if="address" class="fw-bold text-head fs-14px">
                  {{ address }}
                </li>
            ...
            <ul class="contacts-list list-unstyled">
              ...
              >
                ...
                <div class="contact-details">
                  <span
                    class="details-text text-head fs-16px d-block fw-bold"
                    >{{ item.full_name }}</span
                  >
              ...
              <li v-if="searchContacts.length" class="pb-2 text-soft">
                Existing Contacts
              </li>
              <li
      ...
      <div class="col-lg-8">
        <div class="modal-header py-2 px-0">
          <div class="d-flex justify-content-center align-items-center py-0">
            ...
            <span v-if="!isCreateNewContact" class="text-hard fw-bold fs-16px"
              >Edit Contact</span
            >
            <span v-else class="text-hard fw-bold fs-16px">Add Contact</span>
            <svg
              v-if="editContact?.is_primary"
        ...
        <div class="modal-body px-0">
          ...
          <div class="row">
            ...
            <div class="col-lg-4 mb-3 mb-lg-0">
              <div class="">
                ...
                <select v-model="editContact.phone_use" class="form-control">
                  <option value=""></option>
                  <option
                    v-for="(item, index) in intendedUse"
                    :key="index"
          ...
          >
            <div class="col-lg-8 mb-3 mb-lg-0">
              <div class="">
                <label class="form-label-title d-block d-lg-none"
                  >Phone number</label
                >
                <input
                  @click="delete errors?.phone_number"
            ...
            <div class="col-lg-4 mb-3 mb-lg-0">
              <div class="">
                ...
                >
                <select
                  @change="item.phone_use = $event.target.value"
                  class="form-control"
                >
                  <option value=""></option>
                  <option
                    v-for="(intended, index) in intendedUse"
                    :key="index"
          ...
          <div class="row mb-1">
            ...
            <div class="col-lg-4">
              <div
                @click="addedAnotherPhoneHandler()"
          ...
          <div class="row">
            ...
            <div class="col-lg-4 mb-3 mb-lg-0">
              <div class="">
                <label class="form-label-title">Intended use</label>
                <select v-model="editContact.email_use" class="form-control">
                  <option value=""></option>
                  <option
                    v-for="(item, index) in intendedUse"
                    :key="index"
          ...
          >
            ...
            <div class="col-lg-4 mb-3 mb-lg-0">
              <div class="">
                ...
                >
                <select
                  @change="item.email_use = $event.target.value"
                  class="form-control"
                >
                  <option value=""></option>
                  <option
          ...
          <div class="row mb-1">
            ...
            <div class="col-lg-4">
              <div
                @click="addedAnotherEmailHandler()"
                class="fs-14px text-primary cursor-pointer py-1 select-none"
              >
                Add another email
              </div>
          ...
          <div class="d-flex justify-content-between align-items-center pt-2">
            ...
            <loading-button
              :disabled="!(editContact.first_name && editContact.last_name)"
