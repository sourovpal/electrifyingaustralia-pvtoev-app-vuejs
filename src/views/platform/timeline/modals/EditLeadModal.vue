...
watch(editLead, (n) => {
  ...
  leadFormData.estimated_value = n.estimated_value ?? 0.0;
...
<template>
  <bootstrap-modal v-bind="$attrs" ref="leadEditModalRef" size="lg">
    <template #header>
      <div class="modal-header py-2">
        ...
        <div>
          <svg-custom-icon v-if="sourcesIsLoading" icon="SpinnerIcon" />
          <button
            v-else
    ...
    <!-- Lead Properties -->
    <div
      v-show="toggleTabName == tabShowAll || toggleTabName == tabLeadProperties"
    >
    ...
    <div class="d-flex justify-content-between align-items-center">
      <button data-mdb-dismiss="modal" class="btn btn-danger">Close</button>
      <LoadingButton
