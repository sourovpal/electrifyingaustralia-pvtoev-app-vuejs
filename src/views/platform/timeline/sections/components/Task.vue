<script setup>
    ...
    async function toggleTaskDeleteConfirmModal(stage = false) {
        if (stage) {
            toggleTaskDelete.value = stage;
            await nextTick();
            deleteConfirmModalRef.value.modalShow();
        } else {
            deleteConfirmModalRef.value.modalHide();
            toggleTaskDelete.value = stage;
        }
    }
...
<template>
            ...
            <div class="action ms-auto d-flex justify-content-between align-items-center">
                ...
                <div v-else
                    ...
                    <div class="dropdown-menu dot-menu-items">
                        <button @click="toggleTaskDeleteConfirmModal(true)"
                            :disabled="isNew"
                            class="dropdown-item py-1 fs-14px fw-bold text-head">Delete</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <CustomModal ref="deleteConfirmModalRef"
        ...
        <div class="d-flex justify-content-between align-items-center">
            <button @click="toggleTaskDeleteConfirmModal(false)"
