                ...
                <div class="row mt-lg-5 mt-0">
                    ...
                    <div class="col-lg-6 col-12">
                        ...
                        <div class="settings-group-item">
                            ...
                            <input @focus="delete errors?.sub_title" v-model="sub_title" type="text" class="form-control form-control-input" value="Electrifying Australia PTY LTD">
                        ...
                        <div class="settings-group-item about-us-description">
                            ...
                            <textarea @focus="delete errors?.description" v-model="description" class="form-control form-control-input" cols="30" rows="8"></textarea>
