...
export default {
  ...
  methods: {
    async logoutOthersDevice(token_id) {
      try {
  ...
  <div class="row">
    ...
    <div class="col-lg-9 col-12" id="action-session">
      <CustomScrollbar thumbWidth="5">
        <table
          class="table table-borderless table-sm table-striped- mb-0 table-hover table-light"
        >
          <thead>
            <tr>
              <th class="fw-bold py-1" width="25%" scope="col">Browser</th>
              <th
                class="fw-bold py-1 d-none d-lg-table-cell"
                width="20%"
                scope="col"
              >
                Location
          ...
          <tbody>
            ...
            >
              ...
              <td scope="col" class="py-1 d-none d-lg-table-cell">
                {{ session.location }}
              </td>
              <td scope="col" class="py-1 d-none d-lg-table-cell">
                {{ session.ip_address }}
              ...
              <td scope="col" class="py-1">
                <span
                  :class="`btn btn-sm py-0 px-1 fs-12px btn-${
            ...
            <tr v-for="(item, index) in 2" v-else>
              <td v-for="(item, index) in 7" :key="index">
                <Skeletor
                  style="width: 100%; height: 20px; border-radius: 3px"
                />
              </td>
            </tr>
          </tbody>
