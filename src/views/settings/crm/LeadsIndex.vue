  ...
  name:'ProfileIndex',
    data() {
      return{
        ...
        list_items: [
          { name: "New",  id: 0 , status:1 },
          { name: "Leads Allocated",  id: 1, status:1  },
          { name: "Contacted & Appointed",  id: 3, status:1  },
          { name: "Proposal Sent",  id: 4, status:1  },
          { name: "Waiting for decision",  id: 5, status:1  },
          { name: "Follow Up",  id: 6, status:1  },
          { name: "Unreachable",  id: 7, status:0 },
          { name: "Cancel after sign",  id: 8, status:0 },
          { name: "Lost",  id: 9, status:0 },
        ],
        dragging: false
      }
    },
            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-9">
                    ...
                    <div class="list-group ">
                                    ...
                                    <div class="action-dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <li>
                                                ...
                                                @click="list_items.splice(index, 1)"
                                                >Delete item</a>
                                            </li>
                                        </ul>
                                    </div>
                        ...
                        <div class="list-group-item py-3 border-top-0 bg-light text-center add-new-lead-status" @click="list_items.push({name:`New Lead Status.. ${list_items.length+1}`, id:list_items.length+1, status:1})">Add New Status...</div>
                    </div>
                    <div class="mt-3">
