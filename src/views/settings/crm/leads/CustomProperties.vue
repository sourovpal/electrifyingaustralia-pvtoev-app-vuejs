...
<template>
    <section class="content properties">
        <div v-if="pipeline_id || pipeline_title"
            class="content-header d-flex justify-content-start align-stages-center my-3">
        ...
        <div class="content-body- border-top">
            <action-bar>
                ...
                <right-action-bar>
                    ...
                    <div class="me-3">
                        <button @click="showCreatePropertieModal"
            ...
            <Datatable>
                ...
                <datatable-header v-if="isFirstLoading || fetchProperties.length">
                    ...
                    <div class="tbl-th"
                        style="width:15rem;">Propertie Name</div>
                    <div class="tbl-th "
                ...
                <datatable-body>
                    ...
                    <div v-if="!isFirstLoading || fetchProperties.length"
                        ...
                        <div style="width:15rem;flex-grow: 1;"
                            class="tbl-td d-none d-lg-flex">
                            <span class="text-overflow-ellipsis btn btn-sm btn-success py-0 px-2">{{ propertie.use_case
                                }}</span>
                        </div>
        ...
        <create-custom-propertie-modal :fetchPropertieDataHandler="fetchPropertieDataHandler"
