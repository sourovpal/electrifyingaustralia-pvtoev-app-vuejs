...
export default {
    ...
    data() {
        return{
            items: [{id:null, title:'Example Pipeline', total_stages:0, created_ago:'1 seconds ago', total_properties:1,}],
        ...
        <div class="section-box d-flex justify-content-start align-items-center" v-for="(item, index) in items" :key="item.id">
            <div class="card pipeline-card flex-grow-1">
                <div class="card-head d-flex justify-content-between align-items-center px-3">
                    ...
                    <div>
                        <router-link :to="item.id?`/settings/crm/leads/${item.id}`:``" class="btn btn-outline-primary edit-pipeline-btn fw-bold btn-sm">Edit pipeline</router-link>
                    </div>
                </div>
                    ...
                    <div class="d-flex align-items-center flex-grow-1 justify-content-end">
                        <div>
                            <router-link 
                                ...
                                :to="item.id?`/settings/crm/leads/properties?pipeline=${item.id}&title=${item.title}`:``">
            ...
            <div class="sorted-arrow">
                <button class="up mb-2" @click="sortedAction('up', index, item)" :disabled="index==0">
                ...
                <button class="down mb-0 mt-2" @click="sortedAction('down', index, item)" :disabled="index==items.length - 1">
