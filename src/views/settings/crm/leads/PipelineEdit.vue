            ...
            async updateOrCreatePipelineHandler() {
                try {
                    ...
                    try {
                        ...
                        if (!this.pipelineId) {
                            this.pipelineId = pipeline.id;
                            this.$router.push({ path: `/settings/crm/pipeline/${pipeline.id}` })
                        }
            ...
            <section class="">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-lg-4 col-12">
                        <p class="mb-3 fs-14px">Active stages represent the part of the pipeline that is "in progress".
                            This will probably be most of the pipeline.</p>
                ...
                <div class="row mb-3">
                    <div class="col-lg-12 col-12 mb-3 mb-lg-0">
                        <div class="settings-group-header">
                            <h2>Successful stages</h2>
                        </div>
                    </div>
                    <div class="col-lg-4 col-12">
                        <p class="mb-3 fs-14px">Unsuccessful stages are ways that things might fail or go wrong. While
                            you might only have one failure type, you can add multiple unsuccessful stages to track
                            different types of failure. </p>
                        <div class="list-group ">
                            <vue-draggable-next class="lead-status-list"
                                tag="div"
                                :list="stages"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-12">
                        <p class="mb-3 fs-14px">Items in your pipeline which succeed may go on to other pipelines for
                            further work.</p>
                        <div class="list-group ">
                            <vue-draggable-next class="lead-status-list"
                                tag="div"
                ...
                <div class="row">
                    <div class="col-lg-12 mt-3">
                        <button :disabled="isSubmitPipelineStage"
                            @click="updateOrCreatePipelineHandler()"
                            type="submit"
                            class="login-form-control btn btn-primary submit px-3 d-flex justify-content-center align-stages-center">
