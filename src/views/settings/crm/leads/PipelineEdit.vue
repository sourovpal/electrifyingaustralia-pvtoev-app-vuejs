...
<template>
  <div class="content content-y-100vh">
    <div class="content-header d-flex justify-content-start align-stages-center">
      ...
      <h1 class="mb-0 text-soft">{{ pipelineId ? title??'Edit' : "Add New" }}</h1>
    </div>
      ...
      <section class="">
          ...
          <div class="col-lg-4">
            <div class="settings-group-item mb-3">
              <label class="form-label-title">Title
                <span class="ms-3 btn btn-sm btn-danger py-0 px-2 fs-10px">Required</span></label>
        ...
        <div class="row">
          <div class="col-lg-12 mt-3">
            <LoadingButton @click="updateOrCreatePipelineHandler"
