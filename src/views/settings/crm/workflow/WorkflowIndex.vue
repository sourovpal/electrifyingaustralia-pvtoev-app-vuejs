...
<template>
    ...
    <div class="content content-y-100vh">
            ...
            <section class="">
                ...
                <div class="row">
                    <div class="col-lg-7 col-12">
                        <div class="mb-4">
                            <router-link class="text-white btn btn-primary fw-bold"
                                to="/settings/crm/workflows/new">
                        ...
                        <vue-draggable-next class="lead-status-list"
                            ...
                            handle=".handle"
                            v-else>
                            <div class="section-box d-flex justify-content-start align-items-start"
                                    ...
                                    <div class="card-body px-3 position-relative">
                                        ...
                                        <ul class="list-unstyled"
                                            ...
                                            <li class="d-flex gap-2 align-items-center"
                                                v-for="taskObj in item.tasks">
                                                <div><font-awesome-icon icon="fa-solid fa-arrow-right"
                                            ...
                                            <li class="d-flex gap-2 align-items-center mt-3">
                                                ...
                                                <router-link :to="`/settings/crm/workflows/${item.workflow_id}`">
                                                    <span class="mb-0">See more tasks</span>
                                                </router-link>
                                            </li>
                                        </ul>
                                        <span class="text-soft"
                                            v-else>No tasks assigned to this workflow</span>
                                        <div @click="handleDeleteClick(item.workflow_id)"
        ...
        <ConfirmationModal v-if="openWorkflowDeleteConfirmationModal"
