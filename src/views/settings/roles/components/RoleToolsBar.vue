<script setup>
    ...
    const emits = defineEmits(['handlePagination', 'handleSelectAllRows', 'handleAddNew']);
...
<template>
    <action-bar>
        <left-action-bar>
            ...
            <div>
                <button :disabled="isLoading"
                    @click="emits('handlePagination', {page:1})"
        ...
        <right-action-bar>
            <div class="me-3">
                <button @click="emits('handleAddNew', true)"
            ...
            <div class="">
                <button :disabled="!pagination?.prev_page || isLoading"
                    @click="emits('handlePagination', { page: pagination?.prev_page })"
                ...
                <button :disabled="!pagination?.next_page || isLoading"
                    ...
                    @click="emits('handlePagination', { page: pagination?.next_page })"
                    class="toolbar-btn btn btn-light btn-floating me-3">
