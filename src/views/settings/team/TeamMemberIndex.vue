<script setup>
  ...
  const toggleInvitedModal = ref(false);
  const editTeamMember = ref(null);
  ...
  <section class="content team-members">
    ...
    <div class="content-body- border-top">
      ...
      <TeamToolsBar :is-first-loading="isFirstLoading"
        ...
        @handleInvited="toggleInvitedModal = true"></TeamToolsBar>
      ...
      <Datatable :is-first-loading="isFirstLoading"
        ...
        @handleEditMember="(member) => (editTeamMember = member)"></Datatable>

    </div>

    <invite-new-member-modal @close="() => (toggleInvitedModal = false)"
      v-if="toggleInvitedModal"
      @handleRefresh="getAllMembers"></invite-new-member-modal>

    <edit-team-member-modal v-if="editTeamMember"
      @close="() => (editTeamMember = null)"
      :team-member="editTeamMember"
